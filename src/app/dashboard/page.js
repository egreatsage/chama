      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Here's an overview of your Chama activities and savings progress.
              </p>
            </div>
            <Link href="/chamas/create">
        ...
        {stats && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <StatCard
              title="Active Chamas"
              value={stats.activeChamasCount || '0'}
            ...
            <StatCard
              title="This Month"
              value={`KES ${stats.monthlyContribution?.toLocaleString() || '0'}`}
            ...
            <StatCard
              title="Next Payout"
              value={stats.nextPayout || 'None'}
              subtitle="Upcoming rotation"
              icon={
                <svg className="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sm:p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <Link href="/contributions">
              <button className="w-full flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 hover:border-gray-300 transition-all text-left group">
                ...
                <div>
                  <p className="font-semibold text-gray-900">Make Contribution</p>
                  <p className="text-sm text-gray-600">Add funds to your Chamas</p>
                </div>
              </button>
            </Link>
        ...
        {/* Recent Activity Section (placeholder for future feature) */}
